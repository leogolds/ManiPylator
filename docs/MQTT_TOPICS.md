...
All topics follow `manipylator/<domain>/<entity>/<action>`. Every message JSON
includes a `message_schema` string used by `parse_payload()` for deserialization.
...
See also: [API Reference](API_REFERENCE.md) for class signatures and usage patterns.
